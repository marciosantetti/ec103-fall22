...
Let is take the market for *goods and services*, for instance.

  - Thus involving .hi[aggregate household consumption].
  
--

Whenever total production of a good (e.g., cars) is matched by planned expenditures on these goods. 
...
In a closed economy with no foreign sector, an economy will be in .hi-orange[equilibrium] whenever aggregate output (*Y*) equals planned aggregate expenditures.
...
Now, aggregate planned expenditures exceed total output (*C + I > Y*), and firms will have heir inventories reduced.
...
The marginal propensity to save definition is, by definition:
