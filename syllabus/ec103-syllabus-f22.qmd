...
\begin{tabular}{ll|l} 
	...
	\textbf{Web:} & \, \faPencil \, \href{https://www.skidmore.edu/directions/maps.php}{\texttt{Course GitHub Repository}} \\
\end{tabular}
...
Lecture notes and assignments will be posted on the Course's [`GitHub repository`](https://github.com/marciosantetti). Additional readings, answer keys, and data files will be uploaded to `theSpring`. Students will also use `theSpring` to submit all assignments.
